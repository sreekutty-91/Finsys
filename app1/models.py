...
class  rawmaterials(models.Model):
    rawmaterialsid= models.AutoField(("RAWMATERIALSID"), primary_key=True)
    ...
    costofcomponents=models.CharField(max_length=255, default='', blank=True)
    typeofaddnlcost=models.CharField(max_length=255, default='', blank=True)
    percentage=models.CharField(max_length=255, default='', blank=True)
    amount=models.CharField(max_length=255, default='', blank=True)
    totaladdnlcost=models.CharField(max_length=255, default='', blank=True)
...
class rawmaterials1(models.Model) :
    rawmaterialsid= models.AutoField(("RAWMATERIALSID"), primary_key=True)
    productionid=models.ForeignKey(production, on_delete=models.CASCADE)	
    cid = models.ForeignKey(company, on_delete=models.CASCADE)
    Type= models.CharField(max_length=255, default='', blank=True)
    ...
    totalquantity1=models.CharField(max_length=255, default='', blank=True)
    subtotal1=models.CharField(max_length=255, default='', blank=True)
    costofcomponents1=models.CharField(max_length=255, default='', blank=True)
    typeofaddnlcost1=models.CharField(max_length=255, default='', blank=True)
    percentage1=models.CharField(max_length=255, default='', blank=True)
    amount1=models.CharField(max_length=255, default='', blank=True)
    totaladdnlcost1=models.CharField(max_length=255, default='', blank=True)
    effectivecost1=models.CharField(max_length=255, default='', blank=True)
    effectiverate1=models.CharField(max_length=255, default='', blank=True)

class rawmaterials2(models.Model) :
    rawmaterialsid= models.AutoField(("RAWMATERIALSID"), primary_key=True)
    productionid=models.ForeignKey(production, on_delete=models.CASCADE)	
    cid = models.ForeignKey(company, on_delete=models.CASCADE)
    Type= models.CharField(max_length=255, default='', blank=True)
    ...
    totalquantity2=models.CharField(max_length=255, default='', blank=True)
    subtotal2=models.CharField(max_length=255, default='', blank=True)
    costofcomponents2=models.CharField(max_length=255, default='', blank=True)
    typeofaddnlcost2=models.CharField(max_length=255, default='', blank=True)
    percentage2=models.CharField(max_length=255, default='', blank=True)
    amount2=models.CharField(max_length=255, default='', blank=True)
    totaladdnlcost2=models.CharField(max_length=255, default='', blank=True)
    effectivecost2=models.CharField(max_length=255, default='', blank=True)
    effectiverate2=models.CharField(max_length=255, default='', blank=True)

class rawmaterials3(models.Model) :
    rawmaterialsid= models.AutoField(("RAWMATERIALSID"), primary_key=True)
    productionid=models.ForeignKey(production, on_delete=models.CASCADE)	
    cid = models.ForeignKey(company, on_delete=models.CASCADE)
    Type= models.CharField(max_length=255, default='', blank=True)
    ...
    totalquantity3=models.CharField(max_length=255, default='', blank=True)
    subtotal3=models.CharField(max_length=255, default='', blank=True)
    costofcomponents3=models.CharField(max_length=255, default='', blank=True)
    typeofaddnlcost3=models.CharField(max_length=255, default='', blank=True)
    percentage3=models.CharField(max_length=255, default='', blank=True)
    amount3=models.CharField(max_length=255, default='', blank=True)
    totaladdnlcost3=models.CharField(max_length=255, default='', blank=True)
    effectivecost3=models.CharField(max_length=255, default='', blank=True)
    effectiverate3=models.CharField(max_length=255, default='', blank=True)
